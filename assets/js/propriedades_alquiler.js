...
const propiedadesUsadas = (casas, containerId) => {
 const container = document.getElementById(containerId)
 const propiedadActuales = casas
 propiedadActuales.forEach((propiedadActual) => {
  const{
    src,
    nombre,
    descripcion,
...
propiedadesUsadas(propiedades_alquiler, "vender")
}
